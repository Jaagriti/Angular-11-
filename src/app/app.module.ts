...
@NgModule({
  declarations: [
    AppComponent,HeaderComponent, RecepiesComponent, RecepiesListComponent, RecepiesDetailComponent, RecepiesItemComponent, ShoppingListComponent, ShoppingEditComponent
  ],
  imports: [
